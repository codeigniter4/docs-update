...
Often you will need sample data for your application to run its tests. The `Fabricator` class uses fzaninotto's <a href="https://github.com/FakerPHP/Faker" target="_blank">Faker</a> to turn models into generators of random data. Use fabricators in your seeds or test cases to stage fake data for your unit tests.
