...
- [Using MockInputOutput](#using-mockinputoutput)
    - [MockInputOutput](#mockinputoutput)
        - [Helper Methods](#helper-methods)
    - [How to Use](#how-to-use)
- [Without MockInputOutput](#without-mockinputoutput)
    - [Testing CLI Output](#testing-cli-output)
        - [StreamFilterTrait](#streamfiltertrait)
        - [CITestStreamFilter](#citeststreamfilter)
    - [Testing CLI Input](#testing-cli-input)
...
!!! note "Note"
    When you use `MockInputOutput`, you don't need to use `stream-filter-trait`, `ci-test-stream-filter`, and `php-stream-wrapper`.
...
```php
--8<--
testing/overview/018.php
--8<--
```

The `StreamFilterTrait` has a configurator that is called automatically. See [Testing Traits](#testing-overview-traits).
...
!!! note "Note"
    The PhpStreamWrapper is a stream wrapper class. If you don't know PHP's stream wrapper, see \[The streamWrapper class](#https://www.php.net/manual/en/class.streamwrapper.php)\_ in the PHP maual.
