...
- **$filter** `int` The type of filter to apply. A list of filters can be found in \[PHP manual](#https://www.php.net/manual/en/filter.filters.php)\_\_.

- **$flags** `int|array` Flags to apply. A list of flags can be found in \[PHP manual](#https://www.php.net/manual/en/filter.filters.flags.php)\_\_.
