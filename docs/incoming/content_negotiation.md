...
```php
--8<--
incoming/content_negotiation/001.php
--8<--
```
...
```php
--8<--
incoming/content_negotiation/002.php
--8<--
```
...
```php
--8<--
incoming/content_negotiation/003.php
--8<--
```
...
```php
--8<--
incoming/content_negotiation/004.php
--8<--
```
...
```php
--8<--
incoming/content_negotiation/005.php
--8<--
```
...
```php
--8<--
incoming/content_negotiation/006.php
--8<--
```

See more at <a href="https://en.wikipedia.org/wiki/HTTP_compression" target="_blank">Wikipedia</a>.
...
```php
--8<--
incoming/content_negotiation/007.php
--8<--
```
