...
The CodeIgniter 4 open source project has its own \[GitHub organization](#https://github.com/codeigniter4)\_.
...
We also maintain composer-installable packages on \[packagist.org](#https://packagist.org/search/?query=codeigniter4)\_. These correspond to the repositories mentioned above:
...
We maintain a \[codeigniter4projects](#https://github.com/codeigniter4projects)\_ organization on GitHub as well, with projects that are not part of the framework, but which showcase it or make it easier to work with!
