...
3.  If you use Database Driver, you need to recreate the session table. See `sessions-databasehandler-driver`.
...
```php
--8<--
installation/upgrade_sessions/ci3sample/001.php
--8<--
```
...
```php
--8<--
installation/upgrade_sessions/001.php
--8<--
```
