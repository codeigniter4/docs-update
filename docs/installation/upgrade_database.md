...
6.  CI4 does not provide \[Database Caching](#https://www.codeigniter.com/userguide3/database/caching.html)\_ layer known from CI3, so if you need to cache the result, use [Caching](../libraries/caching.md) instead.
...
```php
--8<--
installation/upgrade_database/ci3sample/001.php
--8<--
```
...
```php
--8<--
installation/upgrade_database/001.php
--8<--
```
