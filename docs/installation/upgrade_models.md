...
You can find more information to those methods in [Model](../models/model.md).
...
```php
--8<--
installation/upgrade_models/ci3sample/001.php
--8<--
```
...
```php
--8<--
installation/upgrade_models/001.php
--8<--
```
