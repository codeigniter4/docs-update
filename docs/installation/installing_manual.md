...
!!! note "Note"
    This is the installation technique closest to that described for [CodeIgniter 3](https://codeigniter.com/userguide3/installation/index.html).
...
Download the [latest version of them](https://github.com/codeigniter4/translations/releases/latest). Extract the downloaded zip, and copy the **Language** folder contents in it to your **app/Languages** folder.
