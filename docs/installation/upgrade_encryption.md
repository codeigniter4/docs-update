...
2.  If you need to decrypt data encrypted with CI3's Encryption, configure settings to maintain compatibility. See `encryption-compatible-with-ci3`.
...
```php
--8<--
installation/upgrade_encryption/ci3sample/001.php
--8<--
```
...
```php
--8<--
installation/upgrade_encryption/001.php
--8<--
```
