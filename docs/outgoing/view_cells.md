...
- [Simple and Controlled Cells](#simple-and-controlled-cells)
- [Calling a View Cell](#calling-a-view-cell)
    - [Namespace Omission](#namespace-omission)
    - [Passing Parameters as Key/Value String](#passing-parameters-as-keyvalue-string)
- [Simple Cells](#simple-cells)
- [Controlled Cells](#controlled-cells)
    - [Creating a Controlled Cell](#creating-a-controlled-cell)
    - [Generating Cell via Command](#generating-cell-via-command)
    - [Using a Different View](#using-a-different-view)
    - [Customize the Rendering](#customize-the-rendering)
    - [Computed Properties](#computed-properties)
    - [Presentation Methods](#presentation-methods)
    - [Performing Setup Logic](#performing-setup-logic)
...
```php
--8<--
outgoing/view_cells/001.php
--8<--
```

The string that the Cell returns will be inserted into the view where the `view_cell()` function was called.
...
```php
--8<--
outgoing/view_cells/006.php
--8<--
```

```php
--8<--
outgoing/view_cells/007.php
--8<--
```
...
```php
--8<--
outgoing/view_cells/008.php
--8<--
```

```php
--8<--
outgoing/view_cells/009.php
--8<--
```

```php
--8<--
outgoing/view_cells/010.php
--8<--
```
...
```php
--8<--
outgoing/view_cells/013.php
--8<--
```

```php
--8<--
outgoing/view_cells/014.php
--8<--
```

```php
--8<--
outgoing/view_cells/015.php
--8<--
```
...
```php
--8<--
outgoing/view_cells/016.php
--8<--
```

```php
--8<--
outgoing/view_cells/017.php
--8<--
```
...
```php
--8<--
outgoing/view_cells/019.php
--8<--
```

```php
--8<--
outgoing/view_cells/020.php
--8<--
```
