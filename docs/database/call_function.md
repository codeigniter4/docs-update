...
- [$db-\>callFunction()](#db-callfunction)
...
```php
--8<--
database/call_function/001.php
--8<--
```
...
```php
--8<--
database/call_function/002.php
--8<--
```
...
```php
--8<--
database/call_function/003.php
--8<--
```
...
```php
--8<--
database/call_function/004.php
--8<--
```
