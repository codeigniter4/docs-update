...
- [Information From Executing a Query](#information-from-executing-a-query)
    - [$db-\>insertID()](#db-insertid)
    - [$db-\>affectedRows()](#db-affectedrows)
    - [$db-\>getLastQuery()](#db-getlastquery)
- [Information About Your Database](#information-about-your-database)
    - [$db-\>countAll()](#db-countall)
    - [$db-\>countAllResults()](#db-countallresults)
    - [$db-\>getPlatform()](#db-getplatform)
