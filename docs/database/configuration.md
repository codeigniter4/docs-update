...
!!! important "<p>Important</p>"
    <p>SQLite3 Foreign Key constraint is disabled by default. See [SQLite documentation](#https://www.sqlite.org/pragma.html#pragma-foreign-keys)_. To enforce Foreign Key constraint, set this config item to true.</p></td>
</tr>
<tr>
