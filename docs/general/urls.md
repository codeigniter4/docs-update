...
- [URL Structure](#url-structure)
    - [Base URL contains only the Hostname](#base-url-contains-only-the-hostname)
    - [Base URL contains Sub folders](#base-url-contains-sub-folders)
- [Removing the index.php file](#removing-the-indexphp-file)
...
Your URLs can be defined using the [URI Routing](#/incoming/routing) feature with flexibility.

The [URI Library](#../libraries/uri) and the [URL Helper](#../helpers/url-helper) contain functions that make it easy to work with your URI data.
...
<td>Base URL is often denoted as <strong>baseURL</strong>.</td>
</tr>
<tr>
<td>URI path</td>
<td>/blog/news/2022/10</td>
<td></td>
</tr>
<tr>
<td>Route path</td>
<td>/blog/news/2022/10</td>
<td>The URI path relative to the Base URL. It is also called as <strong>URI string</strong>.</td>
</tr>
<tr>
<td>Query</td>
<td>page=2</td>
...
<tr>
<td>Base URL</td>
<td><strong>https://www.example.com/ci-blog/</strong></td>
<td>Base URL is often denoted as <strong>baseURL</strong>.</td>
</tr>
<tr>
<td>URI path</td>
<td>/ci-blog/blog/news/2022/10</td>
<td></td>
</tr>
<tr>
<td>Route path</td>
...
In this example, any HTTP request other than those for existing directories and existing files are treated as a request for your index.php file.
