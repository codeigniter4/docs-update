...
There are eight different log levels, matching to the <a href="https://tools.ietf.org/html/rfc5424" target="_blank">RFC 5424</a> levels, and they are as follows:
...
- **ChromeLogger Handler** If you have the <a href="https://craig.is/writing/chrome-logger" target="_blank">ChromeLogger extension</a> installed in the Chrome web browser, you can use this handler to display the log information in Chrome's console window.
...
You can use any other logger that you might like as long as it extends from either `Psr\Log\LoggerInterface` and is <a href="https://www.php-fig.org/psr/psr-3/" target="_blank">PSR-3</a> compatible. This means that you can easily drop in use for any PSR-3 compatible logger, or create your own.
