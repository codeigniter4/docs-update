...
- [System Class List](#system-class-list)
- [Replacing Core Classes](#replacing-core-classes)
    - [Creating Your Class](#creating-your-class)
...
1.  the [Autoloader](../general/../concepts/autoloader.md) can find your class,
2.  your new class implements the appropriate interface,
3.  and modify the appropriate [Service](../general/../concepts/services.md) to load your class in place of the core class.
...
```php
--8<--
extending/core_classes/001.php
--8<--
```
...
```php
--8<--
extending/core_classes/002.php
--8<--
```

## Extending Core Classes

If all you need to is add some functionality to an existing library - perhaps add a method or two - then it's overkill to recreate the entire library. In this case, it's better to simply extend the class. Extending the class is nearly identical to [Replacing Core Classes](#replacing-core-classes) with one exception:
...
```php
--8<--
extending/core_classes/003.php
--8<--
```
...
```php
--8<--
extending/core_classes/004.php
--8<--
```
