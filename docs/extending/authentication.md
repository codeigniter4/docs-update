...
CodeIgniter provides an official authentication and authorization framework [CodeIgniter Shield](#shield) for CodeIgniter 4, It is designed to be secure, flexible, and easily extendable to meet the needs of many different types of websites.
...
You may view a list of modules that provide this implementation on <a href="https://packagist.org/providers/codeigniter4/authentication-implementation" target="_blank">Packagist</a>.
