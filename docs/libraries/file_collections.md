...
- [Starting a Collection](#starting-a-collection)
    - [\_\_construct(string\[] $files = \[])](#constructstring-files)
    - [define()](#define)
    - [set(array $files)](#setarray-files)
- [Inputting Files](#inputting-files)
    - [add(string\[]|string $paths, bool $recursive = true)](#addstringstring-paths-bool-recursive-true)
    - [addFile(string $file) / addFiles(array $files)](#addfilestring-file-addfilesarray-files)
    - [removeFile(string $file) / removeFiles(array $files)](#removefilestring-file-removefilesarray-files)
    - [addDirectory(string $directory, bool $recursive = false)](#adddirectorystring-directory-bool-recursive-false)
    - [addDirectories(array $directories, bool $recursive = false)](#adddirectoriesarray-directories-bool-recursive-false)
- [Filtering Files](#filtering-files)
    - [removePattern(string $pattern, string $scope = null)](#removepatternstring-pattern-string-scope-null)
    - [retainPattern(string $pattern, string $scope = null)](#retainpatternstring-pattern-string-scope-null)
- [Retrieving Files](#retrieving-files)
    - [get(): string\[]](#get-string)

## Basic Usage

At its most basic, `FileCollection` is an index of files you set or build:

```php
--8<--
libraries/files/011.php
--8<--
```
