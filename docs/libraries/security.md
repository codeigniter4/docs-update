...
To mitigate compression side-channel attacks like [BREACH](https://en.wikipedia.org/wiki/BREACH), and prevent an attacker from guessing the CSRF tokens, you can configure token randomization (off by default).
