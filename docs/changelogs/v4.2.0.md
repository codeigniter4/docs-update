...
- **OCI8 Driver for Oracle Database** (*contributed by* \[ytetsuro](#https://github.com/ytetsuro)\_). See [Database](#database).

- **Improved Auto Routing** (opt-in) (*contributed by* \[kenjis](#https://github.com/kenjis)\_). See [New Improved Auto Routing](#new-improved-auto-routing).

- Query Builder **Subqueries** and **UNION** support (*contributed by* \[Andrey Pyzhikov](#https://github.com/iRedds)\_). See [Database](#database).
...
See the repo's \[CHANGELOG_4.2.md](#https://github.com/codeigniter4/CodeIgniter4/blob/develop/changelogs/CHANGELOG-4.2.md)\_ for a complete list of bugs fixed.
