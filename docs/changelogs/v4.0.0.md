...
- Kint was updated from the 2.x branch to the latest 3.x branch, with
  new config file to specify options
...
- Tests completely reorganized to make app-level tests simpler out of
  the box.
...
We now have an automated changelog generated in the
[CHANGELOG.md](https://github.com/codeigniter4/CodeIgniter4/blob/develop/CHANGELOG.md)
file in the main repo. See it for more details.
