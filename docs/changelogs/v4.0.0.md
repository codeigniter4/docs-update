...
We now have an automated changelog generated in the <a href="https://github.com/codeigniter4/CodeIgniter4/blob/develop/CHANGELOG.md" target="_blank">CHANGELOG.md</a> file in the main repo. See it for more details.
