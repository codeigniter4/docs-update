...
- [BREAKING](#breaking)
    - [Behavior Changes](#behavior-changes)
        ...
        - [Forge::modifyColumn()](#forgemodifycolumn)
...
- Starting with this version, if you specify a status code in [redirect](#response-redirect-status-code), that code will always be used in the response.
...
- The [$forge-\>modifyColumn()](#db-forge-modifyColumn) has been fixed. Due to a bug, in previous versions, SQLite3/Postgres/SQLSRV might change `NULL`/`NOT NULL` unpredictably.
