...
- Query Builder supports **upsert()**, **upsertBatch()**, **deleteBatch()** and now **\*batch()** methods can set data from a query (*contributed by* [sclubricants](https://github.com/sclubricants)). See [Query Builder](#query-builder).

- Database Forge supports to **add indexes in the existing tables** and **name indexes** (*contributed by* [sclubricants](https://github.com/sclubricants)). See [Forge](#forge).
...
See the repo's [CHANGELOG.md](https://github.com/codeigniter4/CodeIgniter4/blob/develop/CHANGELOG.md) for a complete list of bugs fixed.
