...
- Query Builder supports **upsert()**, **upsertBatch()**, **deleteBatch()** and now **\*batch()** methods can set data from a query (*contributed by* \[sclubricants](#https://github.com/sclubricants)\_). See [Query Builder](#query-builder).

- Database Forge supports to **add indexes in the existing tables** and **name indexes** (*contributed by* \[sclubricants](#https://github.com/sclubricants)\_). See [Forge](#forge).
