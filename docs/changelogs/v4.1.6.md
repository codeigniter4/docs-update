...
- *Deserialization of Untrusted Data* found in the `old()` function was fixed. See the <a href="https://github.com/codeigniter4/CodeIgniter4/security/advisories/GHSA-w6jr-wj64-mc9x" target="_blank">Security advisory</a> for more information.
...
- [Subqueries](#query-builder-where-subquery) in QueryBuilder can now be an instance of the BaseBuilder class.
