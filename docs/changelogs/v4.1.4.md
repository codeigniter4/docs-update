...
See the repo's <a href="https://github.com/codeigniter4/CodeIgniter4/blob/develop/changelogs/CHANGELOG_4.1.md" target="_blank">CHANGELOG_4.1.md</a> for a complete list of changes.
