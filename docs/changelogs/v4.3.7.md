...
- **FeatureTestTrait:** When using [withBodyFormat()](#feature-formatting-the-request), the priority of the request body has been changed. See [Upgrading Guide](#upgrade-437-feature-testing) for details.
