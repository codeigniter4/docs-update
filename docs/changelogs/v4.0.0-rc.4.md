...
- #2458 Replace <span class="title-ref">composer install</span> by <span class="title-ref">composer require</span>
...
- #2392 Add validation function <span class="title-ref">is_not_unique</span>
