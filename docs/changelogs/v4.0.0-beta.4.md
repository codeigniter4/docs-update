...
- #2059 Add multi-path support to <span class="title-ref">locateFile()</span>
...
- #2036 Make <span class="title-ref">force_https()</span> send headers before exit

- #2035 Various typos and Guide corrections

- #2031 Fallback to server request for default method

- #2030 Support the new <span class="title-ref">router</span> service in Debug Toolbar
...
- #2008 Add <span class="title-ref">patch</span> method to command "routes"
