...
`Factories` takes as a second parameter an array of option values
...
To set default component options, create a new Config files at
...
Once stored, the cached versions never expire. Changing a existing
