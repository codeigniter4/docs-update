...
- [CodeIgniter4 Autoloader](#codeigniter4-autoloader)
- [Configuration](#configuration)
    - [Namespaces](#namespaces)
    - [Confirming Namespaces](#confirming-namespaces)
    - [Application Namespace](#application-namespace)
    - [Classmap](#classmap)
- [Composer Support](#composer-support)
    - [Priority of Autoloaders](#priority-of-autoloaders)
- [FileLocator Caching](#filelocator-caching)
    - [How It Works](#how-it-works)
    - [How to Delete Cached Data](#how-to-delete-cached-data)
    - [How to Enable FileLocator Caching](#how-to-enable-filelocator-caching)
...
CodeIgniter provides a very flexible autoloader that can be used with very little configuration. It can locate individual namespaced classes that adhere to \[PSR-4](#https://www.php-fig.org/psr/psr-4/)\_ autoloading directory structures.
...
By default, the application directory is namespace to the `App` namespace. You must namespace the controllers, libraries, or models in the application directory, and they will be found under the `App` namespace.
...
You may change this namespace by editing the **app/Config/Constants.php** file and setting the new namespace value under the `APP_NAMESPACE` setting:

```php
--8<--
concepts/autoloader/002.php:2:
--8<--
```

And if you use Composer autoloader, you also need to change the `App` namespace in your **composer.json**, and run `composer dump-autoload`.
...
!!! note "Note"
    Since v4.5.0 appstarter, the `App\\` namespace has been added to **composer.json**'s `autoload.psr-4`. If your **composer.json** does not have it, adding it may improve your app's autoloading performance.
...
By default, it looks for Composer's autoload file at `ROOTPATH . 'vendor/autoload.php'`. If you need to change the location of that file for any reason, you can modify the value defined in **app/Config/Constants.php**.
