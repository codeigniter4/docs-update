...
While PHP provides ways to interact with the request and response headers, CodeIgniter, like most frameworks, abstracts them so that you have a consistent, simple interface to them. The [IncomingRequest class](#/incoming/incomingrequest) is an object-oriented representation of the HTTP request. It provides everything you need:

```php
--8<--
concepts/http/001.php
--8<--
```
...
CodeIgniter also provides a [Response class](#/outgoing/response) that is an object-oriented representation of the HTTP response. This gives you an easy and powerful way to construct your response to the client:

```php
--8<--
concepts/http/002.php
--8<--
```
