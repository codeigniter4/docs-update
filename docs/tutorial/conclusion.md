...
Now that you've completed this tutorial, we recommend you check out the rest of the documentation. CodeIgniter is often praised because of its comprehensive documentation. Use this to your advantage and read the [Overview](#../concepts/index) and [Index](../general/index.md) sections thoroughly. You should read the [Library](#../libraries/index) and [Index](../helpers/index.md) references when needed.
...
- Check out our \[Slack](#https://join.slack.com/t/codeigniterchat/shared-invite/zt-rl30zw00-obL1Hr1q1ATvkzVkFp8S0Q)\_
